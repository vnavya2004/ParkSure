...
import 'package:parking/UserDashboard/dashboard.dart';// Import the MyProfilePage
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(icon: Icon(Icons.money_off, color: Colors.white), text: 'Pay at Location'),
            Tab(icon: Icon(Icons.payment, color: Colors.white), text: 'Paid (Online)'),
          ],
        ),
      ),
      body: Column(
