...
class BookingSuccessful extends StatefulWidget {
  final dynamic spot;
  final Map data;
  const BookingSuccessful({required Key key, required this.spot, required this.data}) : super(key: key);
  @override
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  SuccessTokens(
                    label: 'From',
                    value: '${widget.data['checkin'] ?? ''} ${widget.data['checkinDate'] ?? ''}',

                  ),
                  Spacer(),
                  SuccessTokens(
                    label: 'To',
                    value: '${widget.data['checkout'] ?? ''} ${widget.data['checkoutDate'] ?? ''}',
