              ...
              children: <Widget>[
                Container(
                 ...
                 child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Colors.grey.shade200, // Replaces 'color' from FlatButton
                    ),
                    child: const Text(
                      'PAY AT LOCATION',
                    ...
                    onPressed: () {
                      if (((_checkOutTime.hour * 60 + _checkOutTime.minute) - 
                          (_checkInTime.hour * 60 + _checkInTime.minute)) <= 0) {
                ...
                child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: EdgeInsets.all(10),
                      backgroundColor: kprimaryColor, // Equivalent to 'color' in FlatButton
                    ),
                    child: const Text(
                      'PAY NOW',
