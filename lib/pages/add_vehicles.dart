...
class _AddVehicleState extends State<AddVehicle> {
          ...
          child: Column(
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (value) {
                  return (value == null || value.isEmpty) ? "This field must not be empty" : null;
                },
              ...
              Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {  // Add '!' to ensure it's not null
 ...
 void addVehicleToDatabase(String vehicle, String owner, String number) async {
  FirebaseAuth auth = FirebaseAuth.instance;
  final User? user1 = auth.currentUser; // Make it nullable
  ...
  if (user1 != null) { // Check if user exists
    await DatabaseService(uid: user1.uid)
      ...
      print("Error1: $error"); // Handle error properly
    });
  } else {
    print("Error2: User is not logged in");
  }
}
